			...
			<div className="container">
				...
				<div className="text-center">
					<h1 className="font-bold text-4xl lg:text-5xl">
						Um provedor de pagamento único
					</h1>
					<p className="mt-3 text-foreground/60 text-lg">
						Gerencie tudo no mesmo lugar, sob a sua marca.
					</p>
				</div>
					...
					<div className="grid items-center gap-8 rounded-2xl border bg-card/50 p-8 lg:grid-cols-2 lg:gap-16">
						...
						<div>
							...
							<div className="mt-6 gap-4">
								<div className="text-card-foreground flex items-baseline gap-1">
									<StarIcon className="size-6 text-3xl text-highlight" />
									<p className="mt-2 block">
										Monitore assinaturas e transações de membros
									</p>
								</div>
								<div className="text-card-foreground flex items-baseline gap-1">
									<StarIcon className="size-6 text-3xl text-highlight" />
									<p className="mt-2 block">
										Alerte os membros para tentarem novamente em caso de falha
										no pagamento
									</p>
								</div>
								<div className="text-card-foreground flex items-baseline gap-1">
								...
								<div className="text-card-foreground flex items-baseline gap-1">
									<StarIcon className="size-6 text-3xl text-highlight" />
									<p className="mt-2 block">
										Realize reembolsos, cancelamentos ou retome assinaturas
									</p>
								</div>
							</div>
						</div>
